...
@_global
def g_checkbox(text, size=2, offset=0, color='default', id=None, cls=None,
               data=None):
    return component('checkbox', text=text, size=size, offset=offset,
                     color=color, id=id, cls=cls or [], data=data or {})
